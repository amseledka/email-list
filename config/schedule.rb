...
job_type :rake, 'source /opt/rvm/environments/ruby-1.9.3-p194@email_lists && bundle install && cd :path && RAILS_ENV=:environment bundle exec rake :task --silent :output'


every :day, :at => '10:40am' do
